        ...
        <div className="App" >
                ...
                <Container fluid>
                    <Row class = 'row'>
                        <Col md={3} style={{textAlign:'start', padding:'0'}}>
                            <Tabs file = {setCreateFile} name='File' newFile='New File' openFile = 'Open File' save = 'Save' saveAs= 'Save as'/>
                            <Tabs name='Edit' undo= 'Undo' redo = 'Redo' cut = 'Cut' copy='Copy' paste ='Paste'/>
                        </Col>
                        <Col md ={7} style={{ textAlign:'center' }}>{fileClicked ? <></> : <Tabs name ={clickedFile.node.name} file={true} style={{color:'rgb(157,165,180)'}}/>}</Col>
            ...
            <SplitPane split="vertical" minSize="0" defaultSize="10%" style={{position:'static'}}>
                ...
                <SplitPane split="vertical" minSize="50%" defaultSize="50%" style={{position:'static'}}>
                    <Editor onChange={handleDocChange} doc={doc} clicked ={fileClicked} />
                    <Preview doc={doc}/>
                </SplitPane>
            </SplitPane>
        </div>
